...
if [ ! -f "artifacts/token_canister.wasm.gz" ]; then
    ...
    curl -L -o artifacts/token_canister.wasm.gz https://github.com/dfinity/ic/releases/download/ledger-suite-icp-2025-07-04/ledger-canister_notify-method.wasm.gz
else
...
if [ ! -f "artifacts/token.did" ]; then
    ...
    curl -L -o artifacts/token.did https://github.com/dfinity/ic/releases/download/ledger-suite-icp-2025-07-04/ledger.did
else
