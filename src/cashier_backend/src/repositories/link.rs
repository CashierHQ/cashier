...
use cashier_backend_types::repository::{keys::LinkKey, link::v1::{Link, LinkCodec}};
use ic_mple_log::service::Storage;
use ic_mple_structures::{BTreeMapStructure, VersionedBTreeMap};
use ic_stable_structures::{DefaultMemoryImpl, memory_manager::VirtualMemory};

pub type LinkRepositoryStorage = VersionedBTreeMap<String, Link, LinkCodec, VirtualMemory<DefaultMemoryImpl>>;
