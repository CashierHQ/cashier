...
mod tests {
    ...
    fn it_should_none_get_user_id_by_wallet() {
        ...
        let user_id = user_service.get_user_id_by_wallet(&Principal::from_text(principal_id).unwrap());
    ...
    fn it_should_get_user_id_by_wallet() {
        ...
        let user_id = user_service.get_user_id_by_wallet(&Principal::from_text(principal_id.clone()).unwrap());
