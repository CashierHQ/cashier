...
mod tests {
    ...
    fn test_try_process_with_window_multiple_requests_within_limit() {
        ...
        for i in 1..=limit {
            let result =
                service.try_process_with_window(user, method, limit, TimeWindow::Minutes(10));
    ...
    fn test_try_process_with_window_different_users_isolated() {
        ...
        for i in 1..=limit {
            let result =
                service.try_process_with_window(user1, method, limit, TimeWindow::Minutes(10));
        ...
        for i in 1..=limit {
            let result =
                service.try_process_with_window(user2, method, limit, TimeWindow::Minutes(10));
    ...
    fn test_try_process_with_window_different_methods_isolated() {
        ...
        for i in 1..=limit {
            let result =
                service.try_process_with_window(user, method1, limit, TimeWindow::Minutes(10));
        ...
        for i in 1..=limit {
            let result =
                service.try_process_with_window(user, method2, limit, TimeWindow::Minutes(10));
