...
mod tests {
    use crate::services::transaction_manager::{
        __tests__::utils::{
            generate_action_with_for_fail, generate_action_with_for_processing,
            generate_mock_action_data, setup_repositories,
        },
    ...
    fn should_all_be_created() {
        ...
        let (
            ...
            txs_hash_map,
        ) = generate_mock_action_data(
            ActionState::Created,
            None,
            Some(IntentState::Created),
            None,
            Some(1),
            Some(cashier_types::TransactionState::Created),
            None,
            false,
        );
    ...
    fn should_all_be_success() {
        ...
        let (
            ...
            None,
            Some(1),
            Some(cashier_types::TransactionState::Success),
            None,
            false,
        );
