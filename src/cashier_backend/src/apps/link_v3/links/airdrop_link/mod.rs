...
impl LinkV3Instance for AirdropLink {
...
mod tests {
    ...
    fn fixture_of_airdrop_link_with_state(
        state: LinkState,
        creator: Principal,
        canister_id: Principal,
        asset_info: Vec<AssetInfoV3>,
    ...
    #[tokio::test]
    async fn it_should_fail_create_action_due_to_unsupported_link_state_for_airdrop_link() {
        // Arrange
        let creator = random_principal_id();
        let canister_id = random_principal_id();
        let created_at = 1_000_000u64;
        let link = fixture_of_airdrop_link_with_state(
            LinkState::Ended,
            creator,
            canister_id,
    ...
    #[tokio::test]
    async fn it_should_fail_process_action_due_to_unsupported_link_state_for_airdrop_link() {
        // Arrange
        let creator = random_principal_id();
        let canister_id = random_principal_id();
        let created_at = 1_000_000u64;
    ...
    fn it_should_succeed_create_airdrop_link() {
        ...
        let created_at = 1_000_000u64;
        let max_use = 7u64;
        let title = "Airdrop test".to_string();
        let asset_info = vec![
        ...
        assert_eq!(link.link.link_type, LinkType::SendAirdrop);
    ...
    #[tokio::test]
    async fn it_should_succeed_create_action_for_created_airdrop_link() {
        // Arrange
        let creator = random_principal_id();
        let canister_id = random_principal_id();
    ...
    #[tokio::test]
    async fn it_should_succeed_process_action_and_activate_created_airdrop_link() {
        // Arrange
        let creator = random_principal_id();
        let canister_id = random_principal_id();
        let ledger_id = random_principal_id();
