...
async fn user_create_link_v3(input: CreateLinkInput) -> Result<CreateLinkDto, CanisterError> {
...
#[update(guard = "is_not_anonymous")]
async fn user_create_action_v3(input: CreateActionInput) -> Result<ActionDto, CanisterError> {
