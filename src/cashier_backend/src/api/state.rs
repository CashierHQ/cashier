...
pub struct CanisterState<E: IcEnvironment + Clone + 'static> {
    ...
    pub link_v3_service: LinkV3Service<ThreadlocalRepositories, IcTransactionManagerV2<E>>,
...
impl<E: IcEnvironment + Clone + 'static> CanisterState<E> {
    ...
    pub fn new(env: E) -> Self {
        ...
        let link_v3_service = LinkV3Service::new(&*repo, transaction_manager_v2.clone());
