...
use crate::{repositories::{ThreadlocalRepositories, LOGGER_SERVICE_STORE}, services::{action::ActionService, link::service::LinkService, request_lock::RequestLockService, transaction_manager::{service::TransactionManagerService, validate::ValidateService}, user::v2::UserService}, utils::runtime::{IcEnvironment, RealIcEnvironment}};
...
pub struct CanisterState {
    ...
    pub transaction_manager_service: TransactionManagerService<RealIcEnvironment, ThreadlocalRepositories>,
