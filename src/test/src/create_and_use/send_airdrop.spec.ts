...
// import { ICP_LABEL } from "../../utils/multiple-token-helper";
...
describe("Test create and claim token airdrop link", () => {
    ...
    describe("With Alice", () => {
        ...
        it("should complete the full link creation process", async () => {
            ...
            const expected_treasury_balance =
                treasury_balance_before + CREATE_LINK_FEE - ledger_fee;
            // after total amount used
            // 1. (amount_per_link_use + ledger_fee) * max_use
            // 2. CREATE_LINK_FEE + ledger_fee
            // 3. approve_fee == ledger_fee
            // Total amount used = airdropAmount + approveAmount + ledger_fee
            const expectedBalanceAfter = balanceBefore - airdropAmount - approveAmount - ledger_fee;
    ...
    //         const walletAddress = fixture.identities.get("bob")!.getPrincipal().toText();
    ...
    //             subaccount: [] as any,
    //         };
    //         const balanceBefore = await fixture.multiTokenHelper!.balanceOf(ICP_LABEL, bobAccount);
    ...
    //         // Verify balance after claim
    //         const balanceAfter = await fixture.multiTokenHelper!.balanceOf(ICP_LABEL, bobAccount);
    //         const balanceChanged = balanceAfter - balanceBefore;
    //         expect(balanceChanged).toEqual(assetInfo.amount_per_link_use! - BigInt(10_000)); // Minus fee
    ...
    //             linkClaimAnymousId,
    //         );
    //         expect(linkBalanceAfter).toEqual(linkBalanceBefore - assetInfo.amount_per_link_use!);
