...
async fn it_should_handle_rate_limit_for_create_action() {
    with_pocket_ic_context::<_, ()>(async move |ctx| {
        ...
        for _ in 0..11 {
            ...
            let res = fixture.create_tip_link(ctx, 100_000_000u64).await;
            links.push(res);
        }
...
async fn it_should_handle_rate_limit_for_different_users() {
    with_pocket_ic_context::<_, ()>(async move |ctx| {
        ...
        for _ in 0..10 {
            ctx.advance_time(Duration::from_secs(60 * 5)).await;
            let link1 = fixture1.create_tip_link(ctx, 100_000_000u64).await;
            links_caller1.push(link1);
            let link2 = fixture2.create_tip_link(ctx, 100_000_000u64).await;
...
async fn it_should_resset_counter_after_10_minutes() {
    with_pocket_ic_context::<_, ()>(async move |ctx| {
        ...
        let new_link = fixture.create_tip_link(ctx, 100_000_000u64).await;
