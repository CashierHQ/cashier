...
use crate::{
    ...
    utils::{
        deploy_canister_with_id, deploy_canister_with_id_sync, deploy_canister_with_settings,
        deploy_canister_with_settings_sync, load_canister_bytecode, principal::TestUser,
    },
};
...
/// Deploys a single ICRC ledger canister with the specified parameters synchronously
pub fn deploy_single_icrc_ledger_canister_sync(
    ...
    match id {
        Some(id) => deploy_canister_with_id_sync(
            client,
            Some(token_deployer_pid),
            None,
            id,
        ...
        None => deploy_canister_with_settings_sync(
            client,
            Some(token_deployer_pid),
            None,
            get_icrc_ledger_canister_bytecode(),
