...
import { commonMessages, descriptionTemplate } from "@/constants/message";
import TipLinkTemplateCard from "@/components/tip-link-template";

const linkTemplateSchema = z.object({
    title: z.string().min(5),
});

export default function TipLinkTemplate({
    defaultValues = {},
    handleSubmit,
    handleChange,
            ...
            <Form {...form}>
                ...
                >
                    ...
                    <TipLinkTemplateCard
                        ...
                        src="/ICP_logo.png"
                        message={commonMessages.TIP_LINK_TEMPLATE_DESCRIPTION}
                        title="1 ICP"
                    />
                    <Button
                        type="submit"
