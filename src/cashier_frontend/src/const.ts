...
export const ICPSWAP_NODE_INDEX_CANISTER_ID = import.meta.env
  .VITE_ICPSWAP_NODE_INDEX_CANISTER_ID || "ggzvv-5qaaa-aaaag-qck7a-cai";
export const KONGSWAP_BACKEND_CANISTER_ID = import.meta.env
  .VITE_KONGSWAP_BACKEND_CANISTER_ID || "2ipq2-uqaaa-aaaar-qailq-cai";
