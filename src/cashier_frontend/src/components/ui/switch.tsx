...
const SwitchRoot = forwardRef<HTMLButtonElement, ComponentProps<typeof SwitchPrimitive.Root>>(
    ({ className, ...props }, ref) => {
        return (
...
const SwitchThumb = forwardRef<HTMLButtonElement, ComponentProps<typeof SwitchPrimitive.Thumb>>(
    ({ className, ...props }, ref) => {
        return (
