...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Item
        ref={ref}
        className={cn(
            "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-2 pr-8 text-sm outline-none focus:bg-light data-[highlighted]:bg-lightgreen data-[state=checked]:bg-lightgreen focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
            className,
        )}
        {...props}
    >
        <span className="absolute right-2 flex h-3.5 w-3.5 items-center justify-center">
            <SelectPrimitive.ItemIndicator>
                <IoMdCheckmark className="h-5 w-5 mr-2" color="#36A18B" />
            </SelectPrimitive.ItemIndicator>
        </span>
