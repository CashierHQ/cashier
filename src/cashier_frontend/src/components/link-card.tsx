...
export default function LinkCard({
    ...
    return (
        <div className="flex flex-col items-center bg-lightgreen rounded-md py-5 mt-5 h-[60vh]">
            <div className="text-lg font-medium">{header}</div>
            <div
                id="phone-frame"
                className="flex flex-col items-center bg-white rounded-[2rem] border-black border-8 mt-3 px-3 h-[100vw] w-[50vw] md:w-[70%]"
            >
                <div
                ...
                <div className="flex flex-col items-center bg-lightgreen rounded-md mt-3 p-3">
                    ...
                    <div
                        className="text-white bg-green rounded-full py-1 mt-3 text-xs w-[100%] text-center"
                        onClick={onClaim}
                    >
                        {label}
                    </div>
