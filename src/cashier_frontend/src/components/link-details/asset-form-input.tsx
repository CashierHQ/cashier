...
export const AssetFormInput: FC<AssetFormInputProps> = ({
  ...
  const { setTokenAmount, setUsdAmount } = useFormActions(
    form,
    localIsUsd,
    index,
  );
    ...
    <div className={` ${showRemoveButton ? "" : ""}`}>
      <div className="input-label-field-container">
        ...
        <div className="flex w-full items-center">
          <Label>
            {isAirdrop ? `Asset per claim` : `${t("create.asset")}`}
          </Label>
          {showRemoveButton && (
            <button
          ...
          <button
            onClick={() => {
              ...
              if (
                ...
                const usdValue =
                  parseFloat(maxTokenAmountWithoutFee.toString()) *
                  tokenUsdPrice;
                setLocalUsdAmount(usdValue.toFixed(7));
              }
          ...
          <AssetButton
            ...
            onMaxClick={() => {
              ...
              if (
                canConvert &&
                tokenUsdPrice &&
                !isNaN(parseFloat(maxTokenAmount))
              ) {
