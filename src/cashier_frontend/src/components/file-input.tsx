...
const FileInput = forwardRef<HTMLInputElement, InputProps>(
    ({ className, defaultValue, onFileChange, ...props }: any, ref) => {
        ...
        return (
            <div tabIndex={0} className="focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-green mt-3">
                {!image && <div className="flex flex-col w-full items-center border-[1px] shadow-sm py-5 rounded-md cursor-pointer" onClick={handleSelect}>
                ...
                }
                {
                    image &&
                    <div>
                        <div style={{ width: "200px", height: "200px", backgroundImage: `url(${image})`, backgroundSize: "contain", borderRadius: "10px" }} />
                        <div className="flex gap-x-[10px] mt-3">
                            <div className="p-2 w-[38px] rounded-md border-[1px] shadow-sm border-gray-200 text-green" onClick={handleDelete}>
                                <FiTrash size="20px" />
                            </div>
                            <div className="p-2 w-[38px] rounded-md border-[1px] shadow-sm border-gray-200 text-green" onClick={handleSelect}>
