  ...
  return (
    <>
      <div className="text-[14px]">
        ICP uses two address formats, Account Id and Principal Id. Centralized
        exchanges use the Account Id, so we encourage you to use the account id
        to avoid sending or receiving to wallets that do not support Principal
        Ids.
      </div>
