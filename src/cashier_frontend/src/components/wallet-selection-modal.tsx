...
export const WalletSelectionModal: React.FC<WalletSelectionModalProps> = ({
    ...
    const { open: confirmOpen, options, hideDialog, showDialog } = useConfirmDialog();
        ...
        <>
            <Dialog open={open} onOpenChange={onOpenChange}>
                <DialogContent className="max-w-sm !rounded-[2rem] border-none shadow-2xl overflow-hidden">
                    <DialogHeader>
                        <DialogTitle>
                            {t("claim.choose_wallet_title", { defaultValue: "Choose your wallet" })}
                        </DialogTitle>
                    </DialogHeader>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            {renderWalletButton(WALLET_OPTIONS.GOOGLE, "Google", undefined, true)}
                            {renderWalletButton(
