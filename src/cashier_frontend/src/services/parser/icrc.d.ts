...
export interface _SERVICE {
  ...
  get_top: ActorMethod<[number], HolderListResp>;
  get_top_100_holder: ActorMethod<[], HolderListResp>;
  get_total_holder: ActorMethod<[], bigint>;
