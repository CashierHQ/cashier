...
import { ACTION_TYPE, ACTION_STATE, LINK_USER_STATE, LINK_TYPE } from "@/services/types/enum";
...
export const useUseConfirmation = ({
    ...
    }, [updateLinkUserState, linkId, anonymousWalletAddress, enhancedRefresh, goToComplete, t]);
