...
export type Result_2 = { Ok: GetLinkResp } | { Err: CanisterError };
export type Result_3 = { Ok: Icrc21ConsentInfo } | { Err: Icrc21Error };
export type Result_4 = { Ok: ActionDto } | { Err: CanisterError };
export type Result_5 = { Ok: CreateLinkDto } | { Err: CanisterError };
export type Result_6 = { Ok: LinkDto } | { Err: CanisterError };
export type Result_7 = { Ok: PaginateResult } | { Err: CanisterError };
export type Result_8 = { Ok: ProcessActionDto } | { Err: CanisterError };
...
export interface _SERVICE {
  ...
  get_link_details_v2: ActorMethod<[string, [] | [GetLinkOptions]], Result_2>;
