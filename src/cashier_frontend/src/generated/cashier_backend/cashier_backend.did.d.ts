...
export type Result = { Ok: ActionDto } | { Err: CanisterError };
export type Result_1 = { Ok: LinkDto } | { Err: CanisterError };
export type Result_2 = { Ok: UserDto } | { Err: string };
export type Result_3 = { Ok: GetLinkResp } | { Err: string };
export type Result_4 = { Ok: PaginateResult } | { Err: string };
export type Result_5 = { Ok: UserDto } | { Err: string };
...
export interface _SERVICE {
  ...
  process_action_anonymous: ActorMethod<[ProcessActionAnonymousInput], Result>;
