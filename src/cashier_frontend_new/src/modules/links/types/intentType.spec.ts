...
describe('IntentType payloads', () => {
  ...
  const to: BackendTransferData['to'] = { IC: { address: p, subaccount: [] } };
  const from: BackendTransferData['from'] = { IC: { address: p, subaccount: [] } };
  ...
  it('constructs TransferFromData correctly', () => {
    const p = Principal.fromText('ryjl3-tyaaa-aaaaa-aaaba-cai');
    const to: BackendTransferFromData['to'] = { IC: { address: p, subaccount: [] } };
    const from: BackendTransferFromData['from'] = { IC: { address: p, subaccount: [] } };
    const asset: BackendTransferFromData['asset'] = { IC: { address: p } };
    const spender: BackendTransferFromData['spender'] = { IC: { address: p, subaccount: [] } };
