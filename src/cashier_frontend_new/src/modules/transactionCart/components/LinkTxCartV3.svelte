<script lang="ts">
  ...
  import { LinkTxCartStoreV3 } from "$modules/transactionCart/state/linkTxCartStoreV3.svelte";
  import {
    FlowDirection,
    type ActionSourceV3,
  ...
  let linkTxCartStore = $state<LinkTxCartStoreV3 | null>(null);
   ...
   */
  onMount(() => {
    linkTxCartStore = new LinkTxCartStoreV3(source);
