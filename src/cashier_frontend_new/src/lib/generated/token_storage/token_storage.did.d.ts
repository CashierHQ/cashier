...
export type Result_1 = { Ok: RegistryStats } | { Err: string };
export type Result_2 = { Ok: Array<[TokenId, bigint]> } | { Err: string };
export type Result_3 = { Ok: UserTokens } | { Err: string };
export type Result_4 = { Ok: null } | { Err: TokenStorageError };
export type Result_5 = { Ok: TokenListResponse } | { Err: string };
export type Result_6 = { Ok: Array<Permission> } | { Err: TokenStorageError };
...
export interface _SERVICE {
   ...
   */
  admin_permissions_add: ActorMethod<[Principal, Array<Permission>], Result_6>;
  /**
  ...
  update_token_balance: ActorMethod<[Array<UpdateTokenBalanceInput>], Result>;
