...
export type MergeUtxosError = { 'NoNeedToMerge' : null } |
...
export type Result_4 = { 'Ok' : string } |
  { 'Err' : MergeUtxosError };
export type Result_5 = { 'Ok' : Array<Utxo> } |
...
export interface UserRollbackRedeemArgs {
  'receiver_icp_addr' : string,
  'txid' : string,
  'target_chain_id' : [] | [string],
  'address' : string,
  'rune_btc_amount' : bigint,
  'rune_amount' : bigint,
  'index' : number,
  'user_sender' : string,
  'rune_id' : string,
...
export interface _SERVICE {
  ...
  'estimate_etching_fee' : ActorMethod<
    ...
    Result_1
  >,
  'estimate_etching_fee_v2' : ActorMethod<
    [string, [] | [LogoParams]],
    Result_1
  >,
  ...
  'rollback_redeem' : ActorMethod<[UserRollbackRedeemArgs], Result_2>,
