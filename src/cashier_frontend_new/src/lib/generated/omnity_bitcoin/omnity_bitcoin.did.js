export const idlFactory = ({ IDL }) => {
  ...
  const BitcoinFeeRate = IDL.Record({
    'low' : IDL.Nat64,
    'high' : IDL.Nat64,
    'medium' : IDL.Nat64,
  });
  ...
  const CustomsInfo = IDL.Record({
    ...
    'nownode_api_secret' : IDL.Opt(IDL.Text),
    'hub_principal' : IDL.Principal,
    'ecdsa_key_name' : IDL.Text,
  ...
  const Event = IDL.Variant({
    ...
    'removed_runes_utxo' : IDL.Record({ 'utxo' : RunesUtxo }),
    ...
    'mark_redeem_ticket_failed' : IDL.Record({
      'refund_ticket_id' : IDL.Opt(IDL.Text),
      'redeem_ticket_id' : IDL.Text,
    }),
    ...
    'stop_retry_btc_transaction' : IDL.Record({ 'tx_id' : IDL.Vec(IDL.Nat8) }),
    'upgrade' : UpgradeArgs,
    'added_chain' : Chain,
    'rollbacked_redeem' : IDL.Vec(Utxo),
    ...
    'update_nownodes_apikey' : IDL.Record({ 'api_key' : IDL.Text }),
    'accepted_rune_tx_request' : RuneTxRequest,
    'updated_rpc_url' : IDL.Record({ 'rpc_url' : IDL.Text }),
    'set_mpc_principal' : IDL.Record({ 'principal' : IDL.Principal }),
  ...
  const MergeUtxosArgs = IDL.Record({
    'min_k' : IDL.Opt(IDL.Nat32),
    'outpoints' : IDL.Opt(IDL.Vec(IDL.Text)),
    'rune_id' : RuneId,
  });
  const MergeUtxosError = IDL.Variant({
    'NoNeedToMerge' : IDL.Null,
    'DuplicateOutpoint' : IDL.Null,
    'RuneIdNotExists' : IDL.Null,
    'Custom' : IDL.Text,
    'OutPointNotFound' : IDL.Null,
    'InvalidArgument' : IDL.Null,
    'InvalidOutPoints' : IDL.Null,
  });
  const Result_4 = IDL.Variant({ 'Ok' : IDL.Text, 'Err' : MergeUtxosError });
  ...
  const UserRollbackRedeemArgs = IDL.Record({
    'receiver_icp_addr' : IDL.Text,
    'txid' : IDL.Text,
    'target_chain_id' : IDL.Opt(IDL.Text),
    'address' : IDL.Text,
    'rune_btc_amount' : IDL.Nat64,
    'rune_amount' : IDL.Nat,
    'index' : IDL.Nat32,
    'user_sender' : IDL.Text,
    'rune_id' : IDL.Text,
  });
  ...
  return IDL.Service({
    'bitcoin_tx' : IDL.Func([IDL.Text], [IDL.Text], ['query']),
    'controller_update_ticket' : IDL.Func([GenerateTicketArgs], [Result], []),
    'estimate_etching_fee' : IDL.Func(
        [IDL.Nat64, IDL.Text, IDL.Opt(LogoParams)],
        [Result_1],
        [],
      ),
    'estimate_etching_fee_v2' : IDL.Func(
        [IDL.Text, IDL.Opt(LogoParams)],
        [Result_1],
        [],
      ),
    'estimate_redeem_fee' : IDL.Func([EstimateFeeArgs], [RedeemFee], ['query']),
    'etching' : IDL.Func([IDL.Nat64, EtchingArgs], [Result_2], []),
    'etching_reveal' : IDL.Func([IDL.Text], [], []),
    'etching_v2' : IDL.Func([EtchingArgs], [Result_2], []),
    'find_btc_address_params' : IDL.Func(
        [IDL.Text],
        [IDL.Opt(GetBtcAddressArgs)],
        ['query'],
      ),
    'fix_misssing_utxo' : IDL.Func(
        [IDL.Vec(IDL.Nat8), Destination, Utxo, RunesBalance],
        [Result_3],
        [],
      ),
    ...
    'get_xpub_key' : IDL.Func([], [ECDSAPublicKey], ['query']),
    'is_deposit_address' : IDL.Func([IDL.Text], [IDL.Bool], ['query']),
    'mark_redeem_ticket_failed' : IDL.Func(
        [IDL.Text, IDL.Opt(IDL.Text)],
        [],
        [],
      ),
    'merge_utxos' : IDL.Func([MergeUtxosArgs], [Result_4], []),
    'query_all_pending_etching' : IDL.Func(
        [],
        [IDL.Vec(SendEtchingInfo)],
        ['query'],
      ),
    ...
    'query_etching_fees_utxos' : IDL.Func([], [IDL.Text], ['query']),
    'refund_btc' : IDL.Func([IDL.Vec(RefundInfo)], [], []),
    ...
    'retry_etching' : IDL.Func([IDL.Text], [Result_2], []),
    'rollback_redeem' : IDL.Func([UserRollbackRedeemArgs], [Result_2], []),
    'runes_main_address' : IDL.Func([IDL.Text], [IDL.Text], []),
    'set_fee_collector' : IDL.Func([IDL.Text, Network], [Result_3], []),
    'set_nownodes_apikey' : IDL.Func([IDL.Text], [], []),
    'set_ord_indexer' : IDL.Func([IDL.Principal], [], []),
    'set_runes_oracle' : IDL.Func([IDL.Principal], [], []),
    'set_tx_fee_per_vbyte' : IDL.Func([BitcoinFeeRate], [Result_3], []),
    'transform' : IDL.Func([TransformArgs], [HttpResponse], ['query']),
    'update_btc_utxos' : IDL.Func([], [Result_5], []),
    'update_etching_fee_utxos' : IDL.Func([], [], []),
    'update_rpc_url' : IDL.Func([IDL.Text], [], []),
    'update_runes_balance' : IDL.Func([UpdateRunesBalanceArgs], [Result_6], []),
  });
};
