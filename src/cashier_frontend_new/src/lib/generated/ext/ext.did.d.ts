...
export interface _SERVICE {
  ...
  'ext_assetStream' : ActorMethod<
    [AssetHandle, Uint8Array | number[], boolean],
    boolean
  >,
  ...
  'ext_setRoyalty' : ActorMethod<[AccountIdentifier__1, bigint], undefined>,
